...
class LRComick(Module):
	...
	def __init__(self,
		...
		self.contexts = Context(hidden_state_dim=words_hidden_state_dimension,											output_dim=2*characters_hidden_state_dimension,
