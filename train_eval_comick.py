...
from comick import ComickDev, ComickUniqueContext, LRComick, LRComickContextOnly, TheFinalComick, Mimick
...
def main(task_config, n=21, k=2, device=0, d=100, epochs=100):
    ...
    model_name = "{}_{}_v{}_mimick".format(model_name, net.__class__.__name__.lower(), net.version)
