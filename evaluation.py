...
def evaluate_embeddings(embeddings, d):

    # Load glove embeddings for comparisons
    logging.info('Loading GloVe embeddings for comparison...')
    glove_valid_embeddings_path = './embeddings_settings/validation_embeddings/glove.6B.{}d.txt'.format(d)
    glove_embeddings = load_embeddings(glove_valid_embeddings_path)
